...
$array_site = array(
					...
					array("pc"=>"https://", "url" => 'm3asia.com', "title" => 'M3 Asia', "icon" => "fa fa-credit-card fa-2x", "s"=>0, "notify"=>1),
					array("pc"=>"https://", "url" => 'm3online.com', "title" => 'M3 Online', "icon" => "fa fa-desktop fa-2x", "s"=>0, "notify"=>1),
					array("pc"=>"https://", "url" => 'getsnapps.com', "title" => 'GetSnapps', "icon" => "fa fa-android fa-2x", "s"=>0, "notify"=>1),
